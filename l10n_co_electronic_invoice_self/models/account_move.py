...
class AccountMove(models.Model):
    ...
    l10n_co_radian_events_sent = fields.Char(
        ...
        copy=False,
        help="Códigos de eventos RADIAN enviados, separados por coma. "
        "Ej: 030,032,033",
    )
    ...
    def action_query_dian_status(self):
        ...
        if mode == "test" and self.l10n_co_dian_zip_key:
            ...
            raise UserError(
                _("No hay CUFE ni ZipKey para consultar " "el estado del documento.")
            )
    ...
    def _l10n_co_get_resolution_message(self):
        ...
        # Extract prefix from document name (e.g. "FEV308" → "FEV")
